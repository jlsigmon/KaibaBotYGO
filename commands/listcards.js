    ...
    execute(msg, args, con, Discord){
        ...
        if(args.length === 1){
            ...
            if(args[1].toLowerCase() === "sortby:"){
                ...
                if(sortBy === "cardd"){
                    con.query(`SELECT * FROM collection WHERE userId = '${msg.author.id}' ORDER BY cardName DESC`, (err, rows) => {
                        if (err) throw err;
                ...
                if(sortBy === "raritya"){
                    con.query(`SELECT * FROM collection WHERE userId = '${msg.author.id}' ORDER BY cardRarity ASC`, (err, rows) => {
                        if (err) throw err;
                ...
                if(sortBy === "rarityd"){
                    con.query(`SELECT * FROM collection WHERE userId = '${msg.author.id}' ORDER BY cardRarity DESC`, (err, rows) => {
                        if (err) throw err;
                ...
                if(sortBy === "#d"){
                    con.query(`SELECT * FROM collection WHERE userId = '${msg.author.id}' ORDER BY cardNum DESC`, (err, rows) => {
                        if (err) throw err;
                ...
                if(sortBy === "#a"){
                    con.query(`SELECT * FROM collection WHERE userId = '${msg.author.id}' ORDER BY cardNum ASC`, (err, rows) => {
                        if (err) throw err;
                ...
                var rarity = args[2];
                    ...
                    con.query(`SELECT * FROM collection WHERE userId = '${msg.author.id}' AND cardRarity = "${rarity}" ORDER BY cardName ASC`, (err, rows) => {
                        if (err) throw err;

    ...
    execute(msg, args, Discord, PREFIX){
        if (!args[1]) {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .addField('More Info', 'Do ' + PREFIX + 'help (command) for more info!');
            ...
            switch (args[1]) {
                case 'points':
                    const embed = new Discord.MessageEmbed()
                        .setTitle('Points')
                        .addField('Desc', 'View how many Kaiba Tokens you have')
                ...
                case 'buydeck':
                    const embed4 = new Discord.MessageEmbed()
                        ...
                        .addField('Decks', 'Light, Dark, Water, Earth, Wind, Swordmasters')
                ...
                case 'convert':
                    const embed20 = new Discord.MessageEmbed()
                        .setTitle('Convert')
                        .addField('Desc', 'Allows you to convert any extra cards into points! Convert gives 10 points for commons, 20 for uncommons, 50 for rares, 100 for ultras, and 1000 for secrets!')
                ...
                case 'viewshop':
                    const embed56 = new Discord.MessageEmbed()
                        .setTitle('View Shop')
                        .addField('Desc', 'Allows you to view the current cards in the shop!')
                ...
                case 'shopbuy':
                    const embed57 = new Discord.MessageEmbed()
                        ...
                        .addField('Usage', PREFIX + 'shopbuy ID# so k!shopbuy 3 would by the 3rd card.');
